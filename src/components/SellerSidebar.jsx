...
export default function SellerSidebar({ current }) {
        ...
        <div className="bg-[#27221F] text-white w-[250px] h-[100%] fixed px-2 py-3 select-none">
            ...
            }
            {
                current == 'orders' ?
                    ...
                    :
                    <div onClick={()=>navigate('/seller/dashboard/order')} className="font-inter my-1 rounded-2xl px-4 py-2 flex items-center space-x-2 text-sm cursor-pointer">
                        <FaBoxOpen />
                        <div>Manage Orders</div>
                    </div>
            }
