...
export default function ManagerPets() {
  ...
  async function handlerPetAdd() {
    ...
    if (
      ...
      await axios
        .post(
          `${import.meta.env.VITE_API_BASE_URL}/user/managepets/addpet`,
          formData,
          {
            headers: {
              "Content-Type": "multipart/form-data",
              Authorization: `Bearer ${cookies.petx}`,
            },
          }
        )
        .then((res) => {
  ...
  async function handleEditFunction() {
    if (
      ...
      await axios
        .post(
          `${import.meta.env.VITE_API_BASE_URL}/user/managepets/updatepet`,
          {
            name: name,
            age: age,
            gender: gender,
    ...
    <div className="container min-h-dvh pt-13">
      <div className="">
        ...
        <div className="h-auto ml-[250px] px-10 py-7">
            ...
            <div className="mt-4">
              <div className="flex space-x-3">
                <div className="text-sm w-[250px] mt-2">
                  <p>
                    Pet Name<sup className="text-red-500">*</sup>
                  </p>
                  <input
                    ref={nameRef}
                    className="text-xs w-full mt-1 px-3 py-2 border-2 focus:outline-none focus:border-[#FB7E46] rounded-lg"
                    value={name}
                ...
                <div className="text-sm w-[250px] mt-2">
                  <p>
                    Age of Pet (month)<sup className="text-red-500">*</sup>
                  </p>
                  <input
                    ref={ageRef}
                    className="text-xs w-full mt-1 px-3 py-2 border-2 focus:outline-none focus:border-[#FB7E46] rounded-lg"
                ...
                <div className="text-sm w-[250px] mt-2">
                  ...
                  <select
                    ...
                    className="bg-white mt-1 w-full py-2 px-3 font-inter text-xs border-2 rounded-lg border-[#124C5F]"
                    name=""
                    id=""
                  >
              ...
              <div className="flex space-x-3">
                ...
                <div className="text-sm w-[250px] mt-2">
                  <p>
                    Want to Sale<sup className="text-red-500">*</sup>
                  </p>
                  <select
                    ref={saleRef}
                    value={sale}
              ...
              <div className="flex space-x-3 mt-1">
                <div className="text-sm w-[250px] mt-2">
                  <p>
                    Pets Images<sup className="text-red-500">*</sup>
                  </p>
                  <input
                    ref={selectedFileRef}
                    onChange={handleFileChange}
                    multiple
                    className="remove-arrow bg-white mt-1 w-full py-2 px-3 font-inter text-xs border-2 rounded-lg border-[#124C5F]"
                    type="file"
                    name=""
                    id=""
                  />
                ...
                {editOption ? (
                  <>
                    <button
                      ...
                      className="flex items-center justify-center mt-3 select-none w-fit px-10 cursor-pointer bg-[#124C5F] text-white text-center font-inter font-semibold text-xs py-2 rounded-sm"
                    >
                      <div ref={btnTextRef1}>Edit Pet</div>
                    ...
                    <button
                      ...
                      className="flex items-center justify-center mt-3 select-none w-fit px-10 cursor-pointer bg-[#e85451] text-white text-center font-inter font-semibold text-xs py-2 rounded-sm"
                    >
                      <div>Cancel</div>
                    </button>
                  </>
                  ...
                  <button
                    ref={btnDivRef}
                    onClick={handlerPetAdd}
                    className="flex items-center justify-center mt-3 select-none w-fit px-10 cursor-pointer bg-[#124C5F] text-white text-center font-inter font-semibold text-xs py-2 rounded-sm"
                  >
                    <div ref={btnTextRef}>Add Pet</div>
          ...
          <div className="mt-10 px-2">
            <div className="font-staatliches text-xl mb-3">Manage Pets</div>
            <div className="space-y-4">
              {user?.profile.pets.length === 0 ? (
                <div className="text-base text-red-400 font-bold">
                  No Product Exists
                </div>
              ) : (
                user?.profile.pets.map((elm) => (
                  <PetAdmin
                    setName={setName}
                    setAge={setAge}
                    setGender={setGender}
